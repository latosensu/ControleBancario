...
<html>
	...
	<body>
		<a href="#create-conta" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-conta" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:contaInstance, action:'save']" >
				<fieldset class="form">
